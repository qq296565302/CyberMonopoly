...
class RadioPanel {
    ...
    show() {
        ...
        this.panel = vscode.window.createWebviewPanel('cyberMonopolyRadio', '📻 电台', vscode.ViewColumn.Beside, {
            enableScripts: true,
    ...
    getWebviewContent(webview) {
        ...
        const hlsScriptUri = this.context
            ? webview.asWebviewUri(vscode.Uri.file(path.join(this.context.extensionPath, 'assets', 'hls.min.js')))
            : '';
...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="${(0, nonce_1.buildCspContent)(nonce, webview.cspSource)}; media-src http://127.0.0.1:${proxyPort} blob:; connect-src http://127.0.0.1:${proxyPort};">
  <style nonce="${nonce}">
